...
Shake allows simple and powerful bug reporting. Paste 1 line of code into your app and tell testers to just shake their phone to report bugs!
  ...
  s.platform     = :ios, '11.0'
  s.source       = { :git => 'git@github.com:shakebugs/shake-ios-staging.git', :tag => '14.1.2-rc.978' }
  s.library      = 'z'
  s.requires_arc = true
  s.xcconfig     =  { 'FRAMEWORK_SEARCH_PATHS' => '$(PODS_ROOT)/Shake/' }
  s.source_files = 'Sources/Shake.xcframework/ios-arm64/Shake.framework/Headers/*.{h,m,swift}'
